...
export const SETTINGS_CONTENT: { title: string, description: string, id: string, code: number }[] = [
    {
        code: 1,
    ...
    },
    {
        ...
        description: "Warn about invalid characters at the beginning of a sentence.",
        id: "invalidSentenceStarter"
    },
    {
        code: 6,
        title: "Consider changing first letter to lower case",
        description: "Warn about the need to change the first letter of a sentence to lower case.",
        id: "writeFirstLowercase"
    },
    {
        code: 7,
        title: "Change first letter to upper case",
        description: "Warn about the need to change the first letter of a sentence to upper case.",
    ...
    },
    {
        ...
        description: "Warn about the absence of terminating punctuation at the end of a sentence.",
        id: "missingTerminatingPunctuation"
    },
    {
        code: 10,
        title: "Invalid punctuation at the end of quotation",
        description: "Warn about invalid punctuation at the end of a quotation and suggest correction.",
        id: "invalidPunctuationAtEndOfQuotation"
    },
    {
        code: 11,
        title: "Foreign quotation mark",
        description: "Warn about the use of a foreign quotation mark and suggest correction.",
        id: "foreignQuotationMark"
    },
    {
        code: 12,
        title: "Misplaced closing parenthesis",
        description: "Warn about misplaced closing parenthesis and suggest correction.",
        id: "misplacedClosingParenthesis"
    },
    {
        code: 13,
        title: "Mismatched negative and verb",
        description: "Warn about mismatched negative and verb and suggest correction.",
        id: "negativeVerbMismatch"
    },
    {
        code: 14,
        title: "You should use infinitive ending with a/ä as the second verb",
        description: "Warn about the need to use infinitive ending with 'a/ä' as the second verb.",
        id: "aInfinitiveRequired"
    },
    {
        code: 15,
        title: "You should use infinitive ending with maan/mään as the second verb",
        description: "Warn about the need to use infinitive ending with 'maan/mään' as the second verb.",
    ...
    },
    {
        ...
        description: "Warn about the absence of one or more main verbs in a sentence.",
        id: "missingMainVerb"
    },
    {
        code: 18,
        title: "Check if sentence contains unnecessary verbs or if a comma is missing",
        description: "Warn about the presence of unnecessary verbs or missing commas in a sentence.",
        id: "extraMainVerb"
    }
];
...
export class FinnishSpellcheckSettingTab extends PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: 'What should be classified as an error.' });
